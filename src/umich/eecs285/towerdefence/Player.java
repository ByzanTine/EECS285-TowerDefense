...
public class Player {
	...
	private static final int updatemeomeoIncome = 10; //meomeoIncome increase by this value 
														//every time it upgrades.
	private static final double hasReachedKingRatio = 0.8;
	private static final int roundProfit[] = {45, 60, 60, 75, 120, 90, 105, 120, 120, 147};

	private  Hashtable<Integer, Integer> candyTable; //for buying protecting unit
	private  Hashtable<Integer, Integer> moneyTable; //for sending attacking unit
	...
	private int meomeoIncome;  //used for updating the meomeo, high level meomeo have high income
